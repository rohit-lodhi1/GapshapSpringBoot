...
public class NotificationServiceImpl implements INotificationService{
	...
	public ResponseEntity<?> updateNotification(NotificationRequest request) {
	       Notifications notification = this.notificationRepository.findById(request.getId()).orElseThrow(() -> new ResourceNotFoundException(AppConstants.NOTIFICATION_NOT_FOUND));
